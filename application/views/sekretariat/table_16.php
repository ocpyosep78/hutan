...
<div id="cnt-content"><div class="container"><div class="cnt-normal">
		...
		<table cellpadding="0" cellspacing="0" border="1" class="display datatable">
			...
			<tbody>
				...
				<tr class="<?php echo (($key % 2) == 0) ? 'even' : 'odd'; ?> gradeA">
					...
					<td class="center"><?php echo $row['diterbitkan']; ?></td>
	...
	<div class="form-box hide"><form id="form-editor">
		...
		<div class="input"><input type="text" name="judul" class="short" /></div>
		<div class="clear"></div>
		<div class="label">Diterbitkan Oleh</div>
		<div class="input"><input type="text" name="diterbitkan" class="short" /></div>
		<div class="clear"></div>
		<div class="label">Tahun</div>
		<div class="input"><input type="text" name="tahun" class="short" /></div>
		<div class="clear"></div>
