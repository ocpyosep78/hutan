...
<div id="cnt-content"><div class="container"><div class="cnt-normal">
	...
	<div class="table">
		<table cellpadding="0" cellspacing="0" border="1" class="display datatable">
			<thead>
				<tr>
					<th colspan="6">Jenis Tenaga</th>
					<th rowspan="2">Keterangan</th>
					<th rowspan="2">Dari</th>
					<th rowspan="2">&nbsp;</th>
				</tr>
				<tr>
					<th>Polhut<br />(orang)</th>
					<th>SPORC<br />(orang)</th>
					<th>TPHL<br />(orang)</th>
					<th>PPNS<br />(orang)</th>
					<th>PABIN<br />(orang)</th>
					<th>Pamswakarsa<br />(orang)</th>
				</tr>
			</thead>
			<tbody>
				<?php foreach ($array_record as $key => $row) { ?>
				<tr class="<?php echo (($key % 2) == 0) ? 'even' : 'odd'; ?> gradeA">
					<td class="center"><?php echo $row['polhut']; ?></td>
					<td class="center"><?php echo $row['sporc']; ?></td>
					<td class="center"><?php echo $row['tphl']; ?></td>
					<td class="center"><?php echo $row['ppns']; ?></td>
					<td class="center"><?php echo $row['pabin']; ?></td>
					<td class="center"><?php echo $row['pamswakarsa']; ?></td>
	...
	<div class="form-box hide"><form id="form-editor">
		...
		<div class="input"><input type="text" name="polhut" class="short" /></div>
		<div class="clear"></div>
		<div class="label">SPORC</div>
		<div class="input"><input type="text" name="sporc" class="short" /></div>
		<div class="clear"></div>
		<div class="label">TPHL</div>
		<div class="input"><input type="text" name="tphl" class="short" /></div>
		<div class="clear"></div>
		<div class="label">PPNS</div>
		<div class="input"><input type="text" name="ppns" class="short" /></div>
		<div class="clear"></div>
		<div class="label">PABIN</div>
		<div class="input"><input type="text" name="pabin" class="short" /></div>
		<div class="clear"></div>
		<div class="label">Pamswakarsa</div>
		<div class="input"><input type="text" name="pamswakarsa" class="short" /></div>
		<div class="clear"></div>
