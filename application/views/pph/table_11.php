...
<div id="cnt-content"><div class="container"><div class="cnt-normal">
		...
		<table cellpadding="0" cellspacing="0" border="1" class="display datatable">
			<thead>
				<tr>
					<th>Jenis Bencana</th>
					<th>Luas/Volume</th>
					<th>Perkiraan kerugian (Rp)</th>
					<th>Upaya pengendalian dan penanggulangan</th>
					<th>Keterangan</th>
					<th>&nbsp;</th>
				</tr>
			</thead>
	...
	<div class="form-box hide"><form id="form-editor">
		...
		<div class="input"><input type="text" name="bencana" class="long" /></div>
		<div class="clear"></div>
		<div class="label">Luas/Volume</div>
		<div class="input"><input type="text" name="luas" class="short" /></div>
		<div class="clear"></div>
		<div class="label">Perkiraan kerugian (Rp)</div>
