...
class sekretariat_table_08_model extends CI_Model {
    function __construct() {
        parent::__construct();
		
        $this->field = array(
			'id', 'sender_id', 'user_type_id', 'pagu', 'target', 'realisasi', 'realisasi_sampai', 'update_time'
		);
    }
    ...
    function get_array($param = array()) {
		...
		$select_query = "
			...
			FROM ".SEKRETARIAT_TABLE_08." store
