...
class pkh_table_13_model extends CI_Model {
    function __construct() {
        ...
        $this->field = array(
			'id', 'sender_id', 'user_type_id', 'jenis', 'title', 'impuls_baik', 'impuls_rusak', 'kompresor_baik', 'kompresor_rusak', 'pompa_jinjing_baik', 'pompa_jinjing_rusak',
