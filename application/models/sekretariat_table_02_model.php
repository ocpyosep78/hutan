...
class sekretariat_table_02_model extends CI_Model {
    function __construct() {
        parent::__construct();
		
        $this->field = array(
			'id', 'sender_id', 'user_type_id', 'gol_1_l', 'gol_1_p', 'gol_2_l', 'gol_2_p', 'gol_3_l', 'gol_3_p', 'gol_4_l', 'gol_4_p', 'update_time'
		);
    }
    ...
    function update($param) {
        ...
        if (empty($param['id'])) {
            $insert_query  = GenerateInsertQuery($this->field, $param, SEKRETARIAT_TABLE_02);
            ...
            $update_query  = GenerateUpdateQuery($this->field, $param, SEKRETARIAT_TABLE_02);
    ...
    function get_by_id($param) {
        ...
        if (isset($param['id'])) {
            $select_query  = "SELECT * FROM ".SEKRETARIAT_TABLE_02." WHERE id = '".$param['id']."' LIMIT 1";
        }
    ...
    function get_array($param = array()) {
		...
		$select_query = "
			...
			FROM ".SEKRETARIAT_TABLE_02." store
    ...
    function delete($param) {
		$delete_query  = "DELETE FROM ".SEKRETARIAT_TABLE_02." WHERE id = '".$param['id']."' LIMIT 1";
