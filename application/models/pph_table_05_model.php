...
class pph_table_05_model extends CI_Model {
    ...
    function update($param) {
        ...
        if (empty($param['id'])) {
            $insert_query  = GenerateInsertQuery($this->field, $param, PPH_TABLE_05);
            ...
            $update_query  = GenerateUpdateQuery($this->field, $param, PPH_TABLE_05);
    ...
    function get_by_id($param) {
        ...
        if (isset($param['id'])) {
            $select_query  = "SELECT * FROM ".PPH_TABLE_05." WHERE id = '".$param['id']."' LIMIT 1";
        }
    ...
    function delete($param) {
		$delete_query  = "DELETE FROM ".PPH_TABLE_05." WHERE id = '".$param['id']."' LIMIT 1";
