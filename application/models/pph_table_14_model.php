...
class pph_table_14_model extends CI_Model {
    function __construct() {
        ...
        $this->field = array(
			'id', 'sender_id', 'user_type_id', 'senpi_genggam', 'senpi_panjang', 'senpi_bius', 'transport_mobil', 'transport_sepeda', 'transport_boat', 'transport_kapal',
