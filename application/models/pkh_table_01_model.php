...
class pkh_table_01_model extends CI_Model {
    function __construct() {
        ...
        $this->field = array(
			'id', 'sender_id', 'user_type_id', 'tanggal_kebakaran', 'lintang', 'bujur', 'lokasi', 'hutan_sm', 'hutan_ca', 'hutan_tn', 'hutan_thr', 'hutan_twa', 'hutan_tb', 'hutan_hl', 'hutan_hti',
