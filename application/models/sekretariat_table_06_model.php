...
class sekretariat_table_06_model extends CI_Model {
    function __construct() {
        parent::__construct();
		
        $this->field = array(
			'id', 'sender_id', 'user_type_id', 'uraian', 's3_l', 's3_p', 's2_l', 's2_p', 's1_l', 's1_p', 'd3_l', 'd3_p', 'slta_l', 'slta_p', 'sltp_l', 'sltp_p', 'sd_l', 'sd_p',
    ...
    function update($param) {
        ...
        if (empty($param['id'])) {
            $insert_query  = GenerateInsertQuery($this->field, $param, SEKRETARIAT_TABLE_06);
            ...
            $update_query  = GenerateUpdateQuery($this->field, $param, SEKRETARIAT_TABLE_06);
    ...
    function get_by_id($param) {
        ...
        if (isset($param['id'])) {
            $select_query  = "SELECT * FROM ".SEKRETARIAT_TABLE_06." WHERE id = '".$param['id']."' LIMIT 1";
        }
    ...
    function get_array($param = array()) {
		...
		$select_query = "
			...
			FROM ".SEKRETARIAT_TABLE_06." store
    ...
    function delete($param) {
		$delete_query  = "DELETE FROM ".SEKRETARIAT_TABLE_06." WHERE id = '".$param['id']."' LIMIT 1";
