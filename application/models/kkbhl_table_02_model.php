...
class kkbhl_table_02_model extends CI_Model {
    function __construct() {
        ...
        $this->field = array(
			'id', 'sender_id', 'user_type_id', 'nama_kawasan', 'penunjukan_no', 'penunjukan_tanggal', 'penunjukan_luas', 'penetapan_no', 'penetapan_tangal', 'penetapan_luas',
