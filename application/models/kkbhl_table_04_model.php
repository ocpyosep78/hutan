...
class kkbhl_table_04_model extends CI_Model {
    function __construct() {
        ...
        $this->field = array(
			'id', 'kawasan_nama_lama', 'kawasan_no_lama', 'kawasan_tanggal_lama', 'kawasan_luas_lama', 'kawasan_nama_baru', 'kawasan_no_baru', 'kawasan_tanggal_baru', 'kawasan_luas_baru', 'update_time'
		);
    }
